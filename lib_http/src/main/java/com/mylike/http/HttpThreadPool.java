...
public class HttpThreadPool {
    ...
    private HttpThreadPool(){
        executor = new ThreadPoolExecutor(CORE_POOL_SIZE,CORE_POOL_SIZE+1,LIVE_TIME,
                TimeUnit.SECONDS,new ArrayBlockingQueue<Runnable>(4),rejectHandler);
